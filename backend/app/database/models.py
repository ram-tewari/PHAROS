...
class DeveloperProfileRecord(Base):
    ...
    # Identity of the analysis owner. The users table was dropped in the Phase 2
    # amputation (single-tenant), so this is a plain column, not a FK.
...
__all__ = [
    ...
    "GraphRelationship",
    "SyntheticQuestion",
    # Annotation models (used by pdf_ingestion)
    "Annotation",
    # Graph models
    "Citation",
    "GraphEdge",
